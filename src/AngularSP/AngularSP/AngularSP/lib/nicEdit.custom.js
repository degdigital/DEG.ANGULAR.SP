...
/*This library has been changed to better calculate the position to show the drop-downs on the toolbar. Check the pos() function for alterations. */
...
var bkElement = bkClass.extend({
	...
	pos : function() {
	    ...
	    return [this.getBoundingClientRect().left, this.getBoundingClientRect().bottom];
	},
